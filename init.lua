...
vim.keymap.set({ 'n', 't' }, '<leader>tt', toggle_terminal, { desc = 'Open terminal' })

-- Buffer Staff
vim.keymap.set('n', '<leader>bw', '<cmd>bw!<cr>', { desc = 'Wipe out' })
  ...
  },
  {
    ...
    config = function()
      ...
      local servers = {
        ...
        -- pyright = {},
        ruff = require 'custom.lsp.ruff',
        rust_analyzer = require 'custom.lsp.rust_analyzer',
        ts_ls = require 'custom.lsp.ts_ls',
        tailwindcss = require 'custom.lsp.tailwindcss',
        -- vtsls = require 'custom.lsp.vtsls',
